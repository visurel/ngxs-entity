...
import { BookModel, TheGreatGatsby, AClockworkOrange, AnimalFarm } from './fixtures/book'
...
describe('Sorted State Adapter', () => {
  ...
  it('should let you add many entities to the state', () => {
    ...
    const withManyMore = adapter.addMany([AClockworkOrange, AnimalFarm], withOneEntity)
  ...
  it('should let you add all entities to the state', () => {
    ...
    const withAll = adapter.addAll([AClockworkOrange, AnimalFarm], withOneEntity)
  ...
  it('should let you remove many entities from the state', () => {
    const withAll = adapter.addAll([TheGreatGatsby, AClockworkOrange, AnimalFarm], state)

    const withoutMany = adapter.removeMany([TheGreatGatsby.id, AClockworkOrange.id], withAll)
  ...
  it('should resort correctly if same id but sort key update', () => {
    const withAll = adapter.addAll([TheGreatGatsby, AnimalFarm, AClockworkOrange], state)
    const changes = { title: 'A New Hope' }
  ...
  it('should resort correctly if the id and sort key update', () => {
    const withOne = adapter.addAll([TheGreatGatsby, AnimalFarm, AClockworkOrange], state)
  ...
  it('should let you update an entity in the state with upsert()', () => {
    ...
    const withUpdates = adapter.upsertOne({ ...TheGreatGatsby, ...changes }, withOne)
    expect(withUpdates).toEqual({
      ids: [TheGreatGatsby.id],
      entities: {
        [TheGreatGatsby.id]: {
